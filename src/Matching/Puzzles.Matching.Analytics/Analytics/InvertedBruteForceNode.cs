...
public sealed record InvertedBruteForceNode(ItemMatch? Step, Grid CurrentPuzzle, InvertedBruteForceNode? Parent) :
	IEqualityOperators<InvertedBruteForceNode, InvertedBruteForceNode, bool>
{
	...
	public InvertedBruteForceNode(Grid currentPuzzle) : this(null, currentPuzzle, null)
	{
	}
